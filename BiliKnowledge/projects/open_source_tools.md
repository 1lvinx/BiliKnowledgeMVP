...
| 工具 | 类型 | 用途 | 来源 | 是否需验证 |
|---|---|---|---|---|
| ghcr.io/karakeep-app/karakeep:latest | docker |  | BV1rS9f8L4bC.md | 是 |

## Python包

| 工具 | 类型 | 用途 | 来源 | 是否需验证 |
|---|---|---|---|---|
| uvicorn | pip |  | BV1sT0g9M5cD.md | 是 |
| asyncpg | pip |  | BV1sT0g9M5cD.md | 是 |
...
| 工具 | 类型 | 用途 | 来源 | 是否需验证 |
|---|---|---|---|---|
| @anthropic-ai/claude-code | npm |  | BV1xK4y1E7pR.md | 是 |
